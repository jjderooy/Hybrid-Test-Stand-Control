...
class ValveControl():
    ...
    def __init__(self, MEVStepperSerialNum = 423768, ventStepperSerialNum = 505958,
                 encoderSerialNum = 426800, pinMEVCloseLimit = 5, pinMEVOpenLimit = 6,
                 pinNCValve = 20, pinIgnitor = 16, pinNCValveRelayIn = 12,
                 pinIgnitorRelayIn = 26, pinLockoutIn = 13, pinVentCloseLimit = 25,
                 pinVentOpenLimit = 21):
